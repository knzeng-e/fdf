...
/*   Updated: 2017/06/20 19:52:29 by knzeng-e         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int ac, char **av)
{
	...
	if (ac == 2)
	{
		...
		infos->size_line = 0;
		infos->endian = 0;
		infos->current_pixel = (t_pixel *)malloc(sizeof(t_pixel));
		infos->map = (t_map *)malloc(sizeof(t_map));
		if (!(infos->current_pixel))
